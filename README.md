...
|---|---|
| **Languages** | C++, Verilog, MATLAB, Assembly, Arduino IDE, Excel VBA |
| **Software/Simulation** | CYME, ASPEN, Vivado, Multisim, EasyEDA, TinkerCAD |
| **Hardware** | Arduino, ESP-32, FPGA, Oscilloscope, Multimeter, Cortex-M |
| **Currently Learning** | Python, AutoCAD, KiCAD |
...
[![Handshake](https://img.shields.io/badge/Handshake-Mina%20George-red?logo=handshake)](https://app.joinhandshake.com/profiles/mina_g)
